...
<select name="faculty" class="form-control">
    ...
    if ($conn) {
        // Check if the 'semester' value is set in the $users array
        if (isset($users['semester'])) {
            // Use prepared statements to avoid SQL injection
            $semester = $users['semester'];
            $stmt = $conn->prepare("SELECT * FROM faculty WHERE semester = ?");
            ...
            if ($result->num_rows > 0) {
                // Loop through the result set and generate the dropdown options
                while ($r = $result->fetch_assoc()) {
                    echo "<option value='" . $r['email'] . "'>" . $r['Name'] . "</option>";
                }
            } else {
                echo "<option>No faculty available for this semester</option>";
            }

            // Close the prepared statement
            $stmt->close();
        } else {
            echo "<option>Semester not set</option>";
        }
    } else {
...
<h3>1-Leadership and Management</h3>
<table class="table table-bordered">
<tr>
<td><b>1:</b> How effective do you find the HOD's leadership style in guiding the department towards its goals?:</td>  
...
<tr>
<td><b>2:</b>How well does the HOD communicate important information and updates to the faculty?:</td> 
...
<h3>2-Support and Resources</h3>
 <table  class="table table-bordered" >
<Td><b>3:</b> How responsive is the HOD to your needs and concerns as a faculty member?:</td>
...
<tr>
<td>
<b>4:</b> Does the HOD provide adequate support and resources for your teaching, research, and professional development?:</td>
<td> 
...
<h3>3-Decision-Making and Involvement</h3>
 <table  class="table table-bordered" >
<tr>
<td><b>5:</b>How transparent is the HOD in decision-making processes that affect the department and its members?:</td>
<td>
...
<tr>
<td><b>6:</b>How inclusive is the HOD in seeking input and feedback from faculty members on departmental matters?:</td>
<Td>
...
<h3>4-Work Environment and Culture</h3>
 <table  class="table table-bordered" >
<tr>
<td><b>7:</b>How well does the HOD foster a positive and collaborative work environment within the department?:</td>
<td>
 <input type="radio" name="quest11" value="5" required> 5
  <input type="radio" name="quest11" value="4">4
  <input type="radio" name="quest11" value="3"> 3
...
<tr>
<td><b>8:</b>How effectively does the HOD address conflicts and issues among faculty members?:</td>
<td>
 <input type="radio" name="quest11" value="5" required> 5
  <input type="radio" name="quest11" value="4">4
  <input type="radio" name="quest11" value="3"> 3
...
<input type="radio" name="quest11" value="1">1</td>
  ...
  <h3>5-Strategic Vision and Planning</h3>
 <table  class="table table-bordered" >
<tr>
<td><b>9:</b>How clear and effective is the HOD's vision for the future of the department?:</td>
<td>
 <input type="radio" name="quest11" value="5" required> 5
  <input type="radio" name="quest11" value="4">4
  <input type="radio" name="quest11" value="3"> 3
...
<tr>
<td><b>10:</b>How well does the HOD implement and follow through on strategic plans and initiatives?:</td>
<td>
 <input type="radio" name="quest11" value="5" required> 5
  <input type="radio" name="quest11" value="4">4
  <input type="radio" name="quest11" value="3"> 3
...
<b>11:</b>What I liked about our HOD:<br><br>
<center>
