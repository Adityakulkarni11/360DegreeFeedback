...
<html lang="en">
  <head>
    ...
    <title>360 Degree feedback System</title>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="index.php?page=givefeedback"><span class="glyphicon glyphicon-thumbs-down"></span> Give Feedback</a></li>
          </ul>
